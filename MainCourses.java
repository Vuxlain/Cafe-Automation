...
public class MainCourses extends MyClass implements MenuIF{
	...
	public MainCourses() {
		...
		System.out.println("1-Ana Yemekler Menusunu Gormek.");
		System.out.println("2-Ana Yemekler Menusune Ekleme.");
		System.out.println("3-Ana Yemekler Menusunden Silme.");
		System.out.println("4-Ana Yemekler Menusunde Degistirme.");
		...
		switch(choose) {
			case 1:	
				try {
					BufferedReader rd = new BufferedReader(new FileReader("txtFiles\\Menu\\MainCourses.txt"));
	...
	public void addItem(String item, int cost) {
		try {
			...
			BufferedWriter wt = new BufferedWriter(new FileWriter("txtFiles\\Menu\\MainCourses.txt"));
	...
	public void deleteItem(BufferedReader rd, String item) {
		try {
			rd = new BufferedReader(new FileReader("txtFiles\\Menu\\MainCourses.txt"));
