...
public class Breakfast extends MyClass implements MenuIF{
	...
	public Breakfast() {
		...
		System.out.println("1-Kahvalti Menusunu Gormek.");
		System.out.println("2-Kahvalti Menusune Ekleme.");
		System.out.println("3-Kahvalti Menusunden Silme.");
		System.out.println("4-Kahvalti Menusunde Degistirme.");
		...
		switch(choose) {
			case 1:	
				try {
					BufferedReader rd = new BufferedReader(new FileReader("txtFiles\\Menu\\Breakfast.txt"));
	...
	public void addItem(String item, int cost) {
		try {
			...
			BufferedWriter wt = new BufferedWriter(new FileWriter("txtFiles\\Menu\\Breakfast.txt"));
	...
	public void deleteItem(BufferedReader rd, String item) {
		try {
			rd = new BufferedReader(new FileReader("txtFiles\\Menu\\Breakfast.txt"));
