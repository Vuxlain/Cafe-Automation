...
public class Desserts extends MyClass implements MenuIF{
	...
	public Desserts() {
		...
		System.out.println("1-Tatlilar Menusunu Gormek.");
		System.out.println("2-Tatlilar Menusune Ekleme.");
		System.out.println("3-Tatlilar Menusunden Silme.");
		System.out.println("4-Tatlilar Menusunde Degistirme.");
		...
		switch(choose) {
			case 1:	
				try {
					BufferedReader rd = new BufferedReader(new FileReader("txtFiles\\Menu\\Desserts.txt"));
	...
	public void addItem(String item, int cost) {
		try {
			...
			BufferedWriter wt = new BufferedWriter(new FileWriter("txtFiles\\Menu\\Desserts.txt"));
	...
	public void deleteItem(BufferedReader rd, String item) {
		try {
			rd = new BufferedReader(new FileReader("txtFiles\\Menu\\Desserts.txt"));
